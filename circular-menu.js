    ...
    (function (global, factory) {
        ...
        function createList(parent, data, index){
            ...
            var background = ['#FF0000', '#ff6961', '#FFA500', '#FFFF00', '#0000FF', '#87CEFA', '#008000', '#008080', '#233f61', '#993399', '#ee82ee', '#ffcbdb', '#ff6f9c', '#00FFFF']
            this._createAnchor(list, data, index, background[index]);
        ...
        function createAnchor (parent, data, index, background) {
            ...
            styleSheet(a, 'background', 'radial-gradient(transparent ' + percent + ', ' + background + ' ' + percent + ')');
